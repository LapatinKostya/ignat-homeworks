...
function Clock() {
    const [timerId, setTimerId] = useState<intervalType | undefined>(undefined)
    ...
    let formatterMounts = new Intl.DateTimeFormat('en-US', {month: "long"})
    let formatterWeekday = new Intl.DateTimeFormat('en-US', {weekday: "long"})
    const stringMonth = formatterMounts.format(date) || <br/> // пишут студенты
